...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get workplaceLabel => 'Χώρος Εργασίας';
  ...
  @override
  String get present => 'Παρόν';

  @override
  String get cvCouldNotLoadTitle =>
      'Δεν ήταν δυνατή η φόρτωση του βιογραφικού σας.';

  @override
  String get cvCouldNotLoadMessage =>
      'Δοκιμάστε να ανανεώσετε τα δεδομένα του προφίλ σας και ανοίξτε το ξανά.';

  @override
  String get goToProfile => 'Μετάβαση στο Προφίλ';

  @override
  String get publishCv => 'Δημοσίευση Βιογραφικού';

  @override
  String get downloadCv => 'Λήψη Βιογραφικού';

  @override
  String get cvDownloadSoon =>
      'Η λήψη του βιογραφικού θα είναι σύντομα διαθέσιμη.';

  @override
  String get returnToProfileSetup => 'Επιστροφή στη Ρύθμιση Προφίλ';

  @override
  String get publishedBadge => 'Δημοσιευμένο';

  @override
  String get draftModeBadge => 'Πρόχειρη Έκδοση';

  @override
  String get cvDraftReviewTitle =>
      'Αυτό είναι το βιογραφικό σας — έτσι σας βλέπουν οι εταιρείες.';

  @override
  String get cvDraftReviewBody =>
      'Ελέγξτε προσεκτικά όλες τις πληροφορίες και κάντε τις απαραίτητες αλλαγές πριν δημοσιεύσετε το βιογραφικό σας.\nΑν το βιογραφικό σας δεν είναι δημοσιευμένο, οι εταιρείες δεν θα μπορούν να το δουν.\nΜπορείτε να ενημερώνετε τα στοιχεία σας ανά πάσα στιγμή μέσω του Προφίλ. Το βιογραφικό σας θα ενημερώνεται αυτόματα.';

  @override
  String get contactVisibilityNote =>
      'Τα στοιχεία επικοινωνίας σας παραμένουν κρυφά έως ότου υποβάλετε αίτηση για κάποια θέση ή αποδεχτείτε πρόσκληση.';

  @override
  String get youBothShareSameValues => 'Μοιράζεστε κοινές αξίες';

  @override
  String get learnMore => 'Μάθετε Περισσότερα';

  @override
  String get greatJob => 'Μπράβο!';

  @override
  String get cvLevelLabel => 'Επίπεδο Βιογραφικού:';

  @override
  String get strongLevel => 'ΙΣΧΥΡΟ';

  @override
  String get cvAssistantImprovementSummary =>
      'Ο βοηθός εντόπισε 4 τομείς βελτίωσης που μπορούν να αυξήσουν τις πιθανότητές σας για εύρεση εργασίας κατά 15%.';

  @override
  String get careerAssistantTitle => 'Ο Βοηθός Καριέρας σας';
  ...
  String get pathfinderAdviceText =>
      'Γεια! Είμαι ο Pathfinder, ο βοηθός καριέρας σας.\nΕξέτασα το προφίλ σας και εντόπισα μερικές γρήγορες βελτιώσεις:\n\n- Κρίσιμο: Η φωτογραφία προφίλ σας φαίνεται θολή. Ανεβάστε μια καθαρή, επαγγελματική εικόνα για καλύτερη πρώτη εντύπωση.\n- Προτεινόμενο: Προσθέστε περισσότερες λεπτομέρειες στην εργασιακή σας εμπειρία — αναφέρετε τι δημιουργήσατε για να δείξετε την πραγματική σας συνεισφορά.\n- Μικρό: Καταγράψτε ένα σύντομο βίντεο παρουσίασης. Βοηθά τις ομάδες να σας γνωρίσουν και κάνει το προφίλ σας να ξεχωρίζει.\nΑυτές οι μικρές αλλαγές θα ενισχύσουν αισθητά την αξιοπιστία και την ορατότητά σας.';

  @override
  String get askCareerPathHint => 'Ρωτήστε με για την καριέρα σας...';

  @override
  String get leaveWithoutPublishingTitle => 'Έξοδος χωρίς δημοσίευση;';

  @override
  String get leaveWithoutPublishingMessage =>
      'Αν φύγετε από αυτή τη σελίδα, το βιογραφικό σας δεν θα δημοσιευτεί και οι εταιρείες δεν θα μπορούν να το δουν. Μπορείτε να το δημοσιεύσετε αργότερα από το προφίλ σας, αλλά συνιστούμε να το κάνετε τώρα για καλύτερες πιθανότητες εύρεσης εργασίας.';

  @override
  String get notSpecified => 'Μη καθορισμένο';

  @override
  String get workspaceLabel => 'Χώρος Εργασίας';

  @override
  String get levelLabel => 'Επίπεδο';

  @override
  String get desiredSalaryLabel => 'Επιθυμητός Μισθός';

  @override
  String get jobPreferencesTabDescription =>
      'Εδώ εμφανίζεται η θέση που αναζητάτε αυτή τη στιγμή. Μπορείτε να το αλλάξετε ανά πάσα στιγμή.';

  @override
  String get preferencesSectionTitle => 'Προτιμήσεις';

  @override
  String experienceAtCompany(String role, String company) {
    return '$role  στη  $company';
  }
  ...
  String assessmentCategoryLabel(String category) {
    return 'Αξιολόγηση $category';
  }

  @override
  String get jobPreferencesUpdated =>
      'Οι προτιμήσεις εργασίας σας ενημερώθηκαν.';

  @override
  String get updateButton => 'Ενημέρωση';

  @override
  String get currentEmailLabel => 'Τρέχον Email';

  @override
  String get updateEmailDescription => 'Ενημερώστε τη διεύθυνση email σας';

  @override
  String get deleteAccountDescription =>
      'Για να διαγράψετε οριστικά τον λογαριασμό σας, πληκτρολογήστε delete στο παρακάτω πεδίο.\nΑυτή η ενέργεια δεν μπορεί να αναιρεθεί — όλα τα δεδομένα σας θα αφαιρεθούν για πάντα.';

  @override
  String get communicationChannelTitle => 'Κανάλι Επικοινωνίας';

  @override
  String get emailNewsletterTitle => 'Newsletter μέσω Email';

  @override
  String get emailNewsletterDescription =>
      'Μείνετε ενημερωμένοι και αξιοποιήστε στο έπακρο την εμπειρία σας! Επιλέξτε τι είδους ενημερώσεις και πληροφορίες θέλετε να λαμβάνετε στο inbox σας.';

  @override
  String get newsletterActive => '(ενεργό)';

  @override
  String get newsletterInactive => '(ανενεργό)';
  ...
  String get settingsUpdatedSuccessfully =>
      'Οι ρυθμίσεις ενημερώθηκαν με επιτυχία.';

  @override
  String get newsletterJobsTitle => 'Προτάσεις Εργασίας';

  @override
  String get newsletterJobsSubtitle =>
      'Εξατομικευμένες προσφορές εργασίας βάσει δεξιοτήτων και προτιμήσεών σας';

  @override
  String get newsletterCareerTipsTitle => 'Συμβουλές Καριέρας';

  @override
  String get newsletterCareerTipsSubtitle =>
      'Εξειδικευμένες συμβουλές και πόροι για την επαγγελματική σας ανάπτυξη';

  @override
  String get newsletterEventsTitle => 'Εκδηλώσεις & Webinars';

  @override
  String get newsletterEventsSubtitle =>
      'Επερχόμενες εκδηλώσεις καριέρας, εργαστήρια και δικτύωση';

  @override
  String get newsletterPlatformTitle => 'Ενημερώσεις Πλατφόρμας';

  @override
  String get newsletterPlatformSubtitle =>
      'Νέες λειτουργίες, εργαλεία και βελτιώσεις προϊόντος';

  @override
  String get newsletterLearningTitle => 'Ευκαιρίες Μάθησης';

  @override
  String get newsletterLearningSubtitle =>
      'Διαδικτυακά μαθήματα και πιστοποιήσεις για την ανάπτυξη των δεξιοτήτων σας';

  @override
  String get uploadFilesTitle => 'Μεταφόρτωση Αρχείων';

  @override
  String get uploadMore => 'Περισσότερες Μεταφορτώσεις';

  @override
  String get uploadFileInstructions =>
      'Πατήστε το κουμπί για αναζήτηση\n(έως 10 αρχεία, μέχρι 5 MB το καθένα·\nυποστηριζόμενα: .pdf, .doc, .png, .jpg)';

  @override
  String get documentUrlDescription =>
      'Δώστε έναν σύνδεσμο εγγράφου για εισαγωγή του στο σύστημα.';

  @override
  String get documentUrlMustBeActive =>
      'Ο σύνδεσμος πρέπει να είναι ενεργός και προσβάσιμος χωρίς σύνδεση.';

  @override
  String get documentUrlSupportedFormats =>
      'Το έγγραφο πρέπει να είναι σε υποστηριζόμενη μορφή (PDF, DOC, DOCX).';

  @override
  String get documentUrlCommonServices =>
      'Συνήθεις υπηρεσίες: Google Drive, Dropbox, iCloud.';

  @override
  String get documentLinkHint => 'Προσθέστε τον σύνδεσμο του εγγράφου';

  @override
  String get fileComplete => 'Ολοκληρώθηκε';

  @override
  String get fileUploading => 'Μεταφόρτωση...';

  @override
  String get fileFallbackLabel => 'ΑΡΧΕΙΟ';

  @override
  String get profileMenuMyProfile => 'Το Προφίλ μου';

  @override
  String get profileMenuMyCv => 'Το Βιογραφικό μου';

  @override
  String get logOut => 'Αποσύνδεση';

  @override
  String get goToJobSearch => 'Μετάβαση στην Αναζήτηση Εργασίας';

  @override
  String get startProductTour => 'Έναρξη Ξενάγησης';

  @override
  String get continueProductTour => 'Συνέχεια Ξενάγησης';

  @override
  String get skipAndClose => 'Παράλειψη και Κλείσιμο';
  ...
  String tourStepIndicator(int current, int total) {
    return 'Βήμα $current / $total';
  }

  @override
  String get tourReadyTitle => 'Είστε Έτοιμοι!';

  @override
  String get tourReadyBody =>
      'Τώρα γνωρίζετε τις κύριες λειτουργίες της πλατφόρμας. Συμπληρώστε το προφίλ σας, κάντε αξιολογήσεις και υποβάλετε αιτήσεις για θέσεις που σας ταιριάζουν.';

  @override
  String get tourWelcomeTitle => 'Ας Ξεκινήσουμε!';

  @override
  String get tourWelcomeBody =>
      'Εδώ μπορείτε να βρείτε μια εργασία που ταιριάζει στις δεξιότητες και την εμπειρία σας. Ας προχωρήσουμε βήμα βήμα.';

  @override
  String get tourSkipTitle => 'Παράλειψη προς το παρόν;';

  @override
  String get tourSkipBody =>
      'Μπορείτε πάντα να κάνετε την ξενάγηση αργότερα από το banner στην Αρχική σελίδα.';

  @override
  String get tourStep1Title => 'Ξεκινήστε Δυναμικά!';

  @override
  String get tourStep1Body =>
      'Εδώ θα βρείτε θέσεις εργασίας και μαθήματα επιλεγμένα για εσάς, πληροφορίες για το βιογραφικό σας και εργαλεία που σας βοηθούν να ξεκινήσετε την αναζήτηση εργασίας.';

  @override
  String get tourStep2Title => 'Βρείτε Εργασία';

  @override
  String get tourStep2Body =>
      'Αναζητήστε θέσεις εργασίας με βάση το όνομα ή επιλέξτε από τις παρακάτω κατηγορίες. Μπορείτε να βρείτε δουλειά κοντά στην πόλη σας ή να ορίσετε άλλες παραμέτρους.';

  @override
  String get tourStep3Title => 'Αγγελία Εργασίας';

  @override
  String get tourStep3Body =>
      'Κάθε κάρτα εργασίας δείχνει τις βασικές πληροφορίες — θέση, τοποθεσία και μισθό. Πατήστε την κάρτα για να δείτε πλήρεις λεπτομέρειες και να υποβάλετε αίτηση.';

  @override
  String get tourStep4Title => 'Δείτε πόσο σας ταιριάζει αυτή η εργασία';

  @override
  String get tourStep4Body =>
      'Αυτό το τμήμα δείχνει πόσο η εμπειρία και οι δεξιότητές σας ταιριάζουν με τη θέση. Όσο υψηλότερο το ποσοστό, τόσο καλύτερες οι πιθανότητές σας.';

  @override
  String get tourStep5Title => 'Λεπτομέρειες Θέσης';

  @override
  String get tourStep5Body =>
      'Διαβάστε την πλήρη περιγραφή, τις απαιτήσεις και τι προσφέρει η εταιρεία πριν υποβάλετε αίτηση.';

  @override
  String get tourStep6Title => 'Εύκολη Υποβολή Αίτησης';

  @override
  String get tourStep6Body =>
      'Η αίτηση είναι εύκολη! Επιλέξτε τη μορφή βιογραφικού και γράψτε λίγα λόγια για τον εαυτό σας στο Συνοδευτικό Γράμμα για καλύτερες πιθανότητες.';

  @override
  String get tourStep7Title => 'Παρακολουθήστε την Πρόοδο';

  @override
  String get tourStep7Body =>
      'Μόλις υποβάλετε αίτηση, μπορείτε να βρείτε την απάντησή σας στις Αιτήσεις μου.';

  @override
  String get tourStep8Title => 'Οι Προσκλήσεις μου';

  @override
  String get tourStep8Body =>
      'Οι εταιρείες μπορούν να σας προσκαλέσουν άμεσα. Μπορείτε να δείτε σχετικές προσκλήσεις από ομάδες που ενδιαφέρονται για το προφίλ σας.';

  @override
  String get tourStep9Title => 'Ξεκινήστε Δυναμικά!';

  @override
  String get tourStep9Body =>
      'Μπορείτε να ανοίξετε την πρόσκληση για να δείτε λεπτομέρειες της θέσης και να αποδεχτείτε την προσφορά.';

  @override
  String get tourStep10Title => 'Δημιουργήστε το Προφίλ σας';

  @override
  String get tourStep10Body =>
      'Το προφίλ σας δείχνει την εμπειρία, τις δεξιότητες και τα στοιχεία επικοινωνίας σας. Ένα πλήρες προφίλ σάς βοηθά να βρείτε καλύτερες αντιστοιχίσεις εργασίας. Μπορείτε να το επεξεργαστείτε ανά πάσα στιγμή.';

  @override
  String get tourStep11Title => 'Γνωρίστε τον Βοηθό Καριέρας σας';

  @override
  String get tourStep11Body =>
      'Ο Pathfinder μπορεί να σας βοηθήσει να βελτιώσετε το προφίλ σας, να βρείτε τις κατάλληλες θέσεις εργασίας και να απαντήσει σε ερωτήσεις σας για την εργασία.';
  ...
  String get tourStep12Body =>
      'Αποκτήστε πρόσβαση σε μαθήματα και πόρους προσαρμοσμένους στους επαγγελματικούς σας στόχους και τις δεξιότητες που αναζητούν οι εταιρείες.';

  @override
  String get tourStep13Title => 'Γνωρίστε τον εαυτό σας καλύτερα';

  @override
  String get tourStep13Body =>
      'Εδώ μπορείτε να κάνετε διάφορες αξιολογήσεις. Τα αποτελέσματά σας αναδεικνύουν τα δυνατά σας σημεία και τον τρόπο εργασίας σας.';

  @override
  String get changePasswordDescription =>
      'Αλλάξτε τον κωδικό σας για να διατηρήσετε τον λογαριασμό σας ασφαλή';

  @override
  String get passwordUpdated => 'Ο κωδικός σας ενημερώθηκε.';

  @override
  String get currentPhoneNumberLabel => 'Τρέχον Αριθμός Τηλεφώνου';

  @override
  String get makeProfileInvisibleDescription =>
      'Αν κάνετε το προφίλ σας αόρατο, οι εταιρείες δεν θα μπορούν να σας βρουν στις αναζητήσεις υποψηφίων. Θα μπορείτε ακόμα να υποβάλετε αιτήσεις για θέσεις που σας ενδιαφέρουν. Μπορείτε να αλλάξετε την ορατότητα ανά πάσα στιγμή στις ρυθμίσεις λογαριασμού σας.';

  @override
  String get makeProfileInvisibleButton => 'Απόκρυψη Προφίλ';

  @override
  String get switchLiteDescription =>
      'Η διεπαφή θα γίνει πιο απλή και εύκολη στη χρήση. Θα σας εμφανίζουμε μόνο τις θέσεις εργασίας που ταιριάζουν καλύτερα με τα ενδιαφέροντά σας.\nΜπορείτε να επιστρέψετε στην πλήρη διεπαφή ανά πάσα στιγμή.';

  @override
  String get switchLiteButton => 'Μετάβαση στο Ithaki Lite';

  @override
  String get switchedToLite => 'Μεταβήκατε στο Ithaki Lite.';
  ...
  String codeSentToContact(String contact) {
    return 'Ένας 6ψήφιος κωδικός στάλθηκε στο $contact σας.';
  }

  @override
  String get phoneViaSms => 'τηλέφωνο μέσω SMS';

  @override
  String get changedEmail => 'Το email σας άλλαξε.';

  @override
  String get changedPhone => 'Ο αριθμός τηλεφώνου σας άλλαξε.';

  @override
  String get jobReportedMessage => 'Η αγγελία εργασίας αναφέρθηκε';

  @override
  String get copyLink => 'Αντιγραφή Συνδέσμου';

  @override
  String get shareWhatsappSms => 'Κοινοποίηση μέσω WhatsApp/SMS';

  @override
  String get shareInEmail => 'Κοινοποίηση μέσω Email';

  @override
  String get shareOnLinkedIn => 'Κοινοποίηση στο LinkedIn';

  @override
  String get industryLabel => 'Κλάδος';

  @override
  String get travelLabel => 'Ταξίδια';

  @override
  String get reportJobDescription =>
      'Η αναφορά αγγελιών μας βοηθά να διατηρούμε υψηλή ποιότητα στις προκηρύξεις εργασίας.';

  @override
  String get tellUsMoreOptional => 'Πείτε μας περισσότερα (προαιρετικό)';

  @override
  String get reportThisJobButton => 'Αναφορά Αγγελίας';

  @override
  String get setReminderButton => 'Ορισμός Υπενθύμισης';

  @override
  String get reminderChoiceTitle => 'Πώς θέλετε να σας υπενθυμιστεί;';

  @override
  String get reminderViaEmail => 'Θα σας στείλουμε υπενθύμιση μέσω email';

  @override
  String get reminderViaSmsWhatsappGeneric =>
      'Θα σας στείλουμε υπενθύμιση μέσω SMS/WhatsApp';

  @override
  String get jobClosedButton => 'Η Θέση Έκλεισε';

  @override
  String get removeFromSaved => 'Αφαίρεση από Αποθηκευμένα';

  @override
  String get newFeatureBanner =>
      'Νέο στο Ithaki! Μόλις κυκλοφορήσαμε νέα λειτουργία που κάνει την αναζήτηση εργασίας πιο εύκολη.';

  @override
  String get curiousWhyMatch =>
      'Θέλετε να μάθετε γιατί ταιριάζετε με αυτή τη θέση;';

  @override
  String get strongSkillsMatch => 'Είναι Ισχυρή αντιστοίχιση\nδεξιοτήτων!';

  @override
  String get goodSkillsMatch => 'Είναι Καλή αντιστοίχιση\nδεξιοτήτων!';

  @override
  String get partialSkillsMatch => 'Είναι Μερική αντιστοίχιση\nδεξιοτήτων!';

  @override
  String get starterSkillsMatch => 'Είναι Αρχική αντιστοίχιση\nδεξιοτήτων!';

  @override
  String get deadlineBannerText => 'Αυτή η θέση έχει προθεσμία! Αιτήσεις\nέως:';

  @override
  String get skillsRequired => 'Απαιτούμενες δεξιότητες';

  @override
  String get aboutRoleTitle => 'Σχετικά με τη θέση';

  @override
  String get requirementsTitle => 'Απαιτήσεις';

  @override
  String get niceToHaveTitle => 'Επιθυμητά προσόντα';

  @override
  String get weOfferTitle => 'Προσφέρουμε';

  @override
  String get shareJob => 'Κοινοποίηση Αγγελίας';

  @override
  String get notInterested => 'Δεν με ενδιαφέρει';

  @override
  String get deleteReminder => 'Διαγραφή Υπενθύμισης';

  @override
  String get salaryRangeLabel => 'Εύρος Μισθού';

  @override
  String get responsibilitiesTitle => 'Αρμοδιότητες';
  ...
  @override
  String get assessmentNotFound => 'Η αξιολόγηση δεν βρέθηκε';

  @override
  String get testDetails => 'Λεπτομέρειες Τεστ';
  ...
  @override
  String get inCv => 'Στο Βιογραφικό';

  @override
  String get showInCv => 'Εμφάνιση στο Βιογραφικό';
  ...
  String rangeNumberSubtitle(
    ...
    return 'Επιλέξτε αριθμό από $min έως $max, όπου $min σημαίνει \"$minLabel\" και $max σημαίνει \"$maxLabel\".';
  }

  @override
  String get addJobInterestTitle => 'Προσθήκη Επαγγελματικού Ενδιαφέροντος';

  @override
  String get searchCityTitle => 'Αναζήτηση Πόλης';

  @override
  String get typeCityHint => 'Πληκτρολογήστε μια πόλη...';

  @override
  String get citySearchTypeMore => 'Πληκτρολογήστε τουλάχιστον 2 χαρακτήρες';

  @override
  String get citySearchNoResults => 'Δεν βρέθηκαν πόλεις';

  @override
  String get photoFileLimit => '5 MB μέγ. · PNG ή JPG';

  @override
  String get photoRecommendation =>
      'Συνιστούμε επαγγελματική φωτογραφία που να δείχνει καθαρά το πρόσωπό σας.';

  @override
  String get uploadPhoto => 'Μεταφόρτωση Φωτογραφίας';

  @override
  String get replacePhoto => 'Αντικατάσταση Φωτογραφίας';

  @override
  String get screeningQuestionsSubtitle =>
      'Εδώ είναι οι απαντήσεις σας σε μερικές ερωτήσεις από τον εργοδότη';

  @override
  String get toJobDetails => 'Προς Λεπτομέρειες Θέσης';

  @override
  String get whatWeOfferTitle => 'Τι προσφέρουμε';

  @override
  String get employeeReviewsTitle => 'Αξιολογήσεις Υπαλλήλων';

  @override
  String get applyButton => 'Αίτηση';

  @override
  String get shareLabel => 'Κοινοποίηση:';

  @override
  String get readArticle => 'Ανάγνωση Άρθρου';

  @override
  String get chatGetStartedHint =>
      'Μπορείτε να ξεκινήσετε με ένα παράδειγμα παρακάτω';
  ...
  String get chatHistorySubtitle =>
      'Μπορείτε να αναζητήσετε σε όλες τις προηγούμενες συνομιλίες σας με λέξεις-κλειδιά ή φράσεις.';

  @override
  String get chatHistorySearchHint =>
      'Πληκτρολογήστε λέξη ή φράση για εύρεση μηνυμάτων...';

  @override
  String get chatHistoryToday => 'Σήμερα';

  @override
  String get chatHistoryLast7Days => 'Τελευταίες 7 ημέρες';

  @override
  String get chatThinking => 'Σκέφτομαι...';

  @override
  String get chatSearchMessagesHint => 'Αναζήτηση μηνυμάτων...';

  @override
  String get culturalFitLabel => 'Πολιτισμική Συμβατότητα';
  ...
  @override
  String get notificationsLabel => 'Ειδοποιήσεις';

  @override
  String get notificationsScreenSubtitle =>
      'Εδώ μπορείτε να δείτε όλα τα νέα σας. Μείνετε ενημερωμένοι με σημαντικές ενημερώσεις.';

  @override
  String notificationsUnreadCount(int count) {
    return 'Έχετε $count νέες ειδοποιήσεις';
  }
  ...
  @override
  String get accountInformationTitle => 'Πληροφορίες Λογαριασμού';

  @override
  String get accountInformationSubtitle =>
      'Διαχειριστείτε τα στοιχεία του λογαριασμού σας για να τον διατηρείτε ασφαλή και ενημερωμένο.';
  ...
  String get profileVisibleForEmployers =>
      'Το Προφίλ είναι Ορατό στους Εργοδότες';

  @override
  String get profileHiddenFromEmployers =>
      'Το Προφίλ είναι Κρυφό από τους Εργοδότες';

  @override
  String get profileVisibilityDescription =>
      'Αυτή τη στιγμή, οι εργοδότες μπορούν να δουν το προφίλ σας και να σας στείλουν προσκλήσεις. Αν προτιμάτε περισσότερη ιδιωτικότητα, μπορείτε να αποκρύψετε το προφίλ σας — θα είναι ορατό μόνο όταν κάνετε αίτηση.';

  @override
  String get hideProfileFromEmployers => 'Απόκρυψη Προφίλ από Εργοδότες';

  @override
  String get showProfileToEmployers => 'Εμφάνιση Προφίλ σε Εργοδότες';

  @override
  String get digitalComfortTitle => 'Ψηφιακή Άνεση';

  @override
  String get digitalComfortExperienced => 'Είστε έμπειρος χρήστης τεχνολογίας';

  @override
  String get digitalComfortDescription =>
      'Χρησιμοποιείτε αυτή τη στιγμή την πλήρη εμπειρία μας — ιδανικό για αυτοπεποίθηση χρήστες. Αν θέλετε μια πιο απλή διεπαφή, μπορείτε να μεταβείτε στην ελαφριά έκδοση.';

  @override
  String get tryIthakiLite => 'Δοκιμάστε το Ithaki Lite';

  @override
  String get deleteAnAccount => 'Διαγραφή Λογαριασμού';

  @override
  String get deleteAccountTabDescription =>
      'Αφαιρέστε οριστικά τον λογαριασμό σας και όλα τα δεδομένα από το σύστημα. Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.';
  ...
  @override
  String get positionInternYears => '0 χρόνια';

  @override
  String get positionJuniorYears => '0–2 χρόνια';

  @override
  String get positionMidYears => '2–5 χρόνια';

  @override
  String get positionSeniorYears => '5–8 χρόνια';

  @override
  String get positionLeadYears => '8–12 χρόνια';

  @override
  String get positionManagerYears => '10+ χρόνια';

  @override
  String get positionDirectorYears => '12+ χρόνια';

  @override
  String get jobCouldNotLoad =>
      'Δεν ήταν δυνατή η φόρτωση αυτής της θέσης εργασίας αυτή τη στιγμή.';

  @override
  String get navHome => 'Αρχική';

  @override
  String get navJobSearch => 'Αναζήτηση Εργασίας';

  @override
  String get navMyApplications => 'Οι Αιτήσεις μου';

  @override
  String get navCareerAssistant => 'Βοηθός Καριέρας';

  @override
  String get navMyAssessments => 'Οι Αξιολογήσεις μου';

  @override
  String get navBlogNews => 'Ιστολόγιο & Νέα';

  @override
  String get profileTabJobPreferences => 'Προτιμήσεις Εργασίας';

  @override
  String get profileTabAboutMe => 'Σχετικά με εμένα';

  @override
  String get profileTabSkills => 'Δεξιότητες';

  @override
  String get profileTabWorkExperience => 'Εργασιακή Εμπειρία';

  @override
  String get profileTabEducation => 'Εκπαίδευση';

  @override
  String get profileTabFiles => 'Αρχεία';

  @override
  String get profileTabValues => 'Αξίες';
  ...
  @override
  String get retryButton => 'Επανάληψη';

  @override
  String get profilePartialLoadWarning =>
      'Ορισμένα δεδομένα προφίλ δεν φορτώθηκαν. Εμφάνιση αποθηκευμένων δεδομένων.';

  @override
  String get editProfileBasicsButton => 'Επεξεργασία Βασικών Στοιχείων';
