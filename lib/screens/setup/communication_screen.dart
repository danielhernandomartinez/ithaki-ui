            ...
            child: Column(
              ...
              children: [
                ...
                IthakiOptionCard(
                  ...
                  onTap: () => setState(() => _selected.contains('whatsapp')
                      ? _selected.remove('whatsapp')
                      : _selected.add('whatsapp')),
                ),
                ...
                IthakiOptionCard(
                  ...
                  onTap: () => setState(() => _selected.contains('sms')
                      ? _selected.remove('sms')
                      : _selected.add('sms')),
                ),
                const SizedBox(height: 12),
                IthakiOptionCard(
                  ...
                  onTap: () => setState(() => _selected.contains('email')
                ...
                IthakiButton(
                  ...
                  onPressed: _selected.isNotEmpty
                      ? () {
                          ref.read(setupProvider.notifier).setCommunication(
                              Set.of(_selected), _receiveTips);
