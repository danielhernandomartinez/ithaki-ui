            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: const TextStyle(
                    fontFamily: 'Noto Sans', fontSize: 16,
                    fontWeight: FontWeight.w400, color: IthakiTheme.textPrimary,
                  ),
                ),
              ),
            ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _CompanyLogo(color: detail.companyLogoColor, initials: detail.companyLogoInitials, size: 60),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Text(detail.companyName,
                        style: const TextStyle(
                          fontFamily: 'Noto Sans', fontSize: 16,
                          color: IthakiTheme.textPrimary, letterSpacing: -0.32,
                        )),
                  ],
                ),
              ),
          ...
          Wrap(
            ...
            runSpacing: 12,
            children: [
              _DetailCell(label: 'Location', icon: 'location', value: detail.location),
              _DetailCell(label: 'Job Type', icon: 'clock', value: detail.jobType),
              _DetailCell(label: 'Industry', value: detail.industry),
              _DetailCell(label: 'Salary Range', value: detail.salaryRange, valueSemibold: true),
              _DetailCell(label: 'Workplace', icon: 'company-profile', value: detail.workplace),
              _DetailCell(label: 'Experience Level', icon: 'level', value: detail.experienceLevel),
              _DetailCell(label: 'Language', icon: 'globe', value: detail.languages, wide: true),
            ],
          ),
        ],
      ),
...
class _DetailCell extends StatelessWidget {
  ...
  const _DetailCell({
    required this.label, this.icon, required this.value,
    this.valueSemibold = false, this.wide = false,
  });
              ...
              Flexible(
                child: Text(value,
                    style: TextStyle(
                      ...
                      fontWeight: valueSemibold ? FontWeight.w600 : FontWeight.w400,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                  color: IthakiTheme.badgeLime, shape: BoxShape.circle,
                ),
          ...
          const SizedBox(height: 12),
          Wrap(spacing: 0, runSpacing: 12, children: [
            _IconInfoCell(icon: 'company-profile', value: candidate.workplacePreference),
            _IconInfoCell(icon: 'clock', value: candidate.employmentPreference),
            _IconInfoCell(icon: 'level', value: candidate.experienceLevel),
            _IconInfoCell(icon: 'bank-note', value: candidate.salaryExpectation, semibold: true),
          ]),
...
class _IconInfoCell extends StatelessWidget {
  ...
  final String value;
  final bool semibold;
  const _IconInfoCell({required this.icon, required this.value, this.semibold = false});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          const Text('Here are your answers to a few questions from the employer',
              style: TextStyle(
                fontFamily: 'Noto Sans', fontSize: 16,
                color: IthakiTheme.textPrimary,
                height: 1.5, letterSpacing: -0.32,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _CompanyLogo(color: company.logoColor, initials: company.logoInitials, size: 64),
              const SizedBox(width: 8),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
          ...
          const SizedBox(height: 12),
          const Text('Team',
              style: TextStyle(fontFamily: 'Noto Sans', fontSize: 14, color: Color(0xFF4B4B4B))),
...
class _CompanyLogo extends StatelessWidget {
  ...
  final double size;
  const _CompanyLogo({required this.color, required this.initials, required this.size});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(initials,
          style: TextStyle(
            fontFamily: 'Noto Sans', fontSize: size * 0.3,
